...
| Tool | Wofür wir es brauchen
| --- | --- |
| GitHub | Zugriff auf Kursdateien und gemeinsame Repositories
| Git | lokale Versionsverwaltung auf dem eigenen Computer 
| Visual Studio Code oder Zed | Code-Editor für Dateien, Projekte und Git-Ansicht
| Terminal | um Befehle auszuführen und Tools zu starten
| Homebrew (macOS) oder WinGet (Windows) | System-Paketmanager zum Installieren und Aktualisieren von Programmen
| Python 3.10 oder neuer | Laufzeit für das Strands SDK
| `pip` | Python-Paketmanager, wird mit Python verwendet 
| Strands Agents SDK | Agenten-Framework, mit dem wir im Kurs arbeiten 
| Ollama | lokale Laufzeit für Sprachmodelle auf dem eigenen Rechner
...
### 4.4 Visual Studio Code oder Zed installieren

**Sehr kurzer Vergleich:**

- **VS Code** ist verbreiteter und hat mehr Extensions und Tutorials.
- **Zed** ist leichter und wirkt oft schneller und reduzierter.

Für den Kurs funktionieren **beide** gut.
...
7. Führe `Shell Command: Install 'code' command in PATH` aus.
...
### 5.4 Visual Studio Code oder Zed installieren

Für Einsteiger*innen ist der **`User setup`** die beste Wahl, weil er keine Administratorrechte braucht.
...
### Empfohlen für den Kurs mit VS Code
...
- [quick-start.md](./quick-start.md) für die kompakte Wiederholung
